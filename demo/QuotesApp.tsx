...
// service: the table exists to watch what the ZRSX instances answer.
const ZAPPER_API_URLS = [
  ...
  { label: 'ZRSX-4', value: 'https://zrsx-4.reserve-api.com/' },
  { label: 'ZRSX-5', value: 'https://zrsx-5.reserve-api.com/' },
  { label: 'Local', value: 'http://localhost:3005/' },
]
